...
class NfcProxy {
  ...
  writeNdef = async ({type, value}) => {
    let result = false;
    console.log('maorwritingsome21', value)
    ...
    try {
      ...
      console.log('maorwritingsome22', value)


      let bytes = null;
      if (type === 'TEXT') {
        console.log('maorwritingsome', value)
  ...
  customTransceiveNfcA = async (commands, onPostExecute) => {
    let result = false;
    const responses = [];
  ...
  customTransceiveNfcV = async (commands, onPostExecute) => {
    let result = false;
    const responses = [];
